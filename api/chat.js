...
// ── Lit les annonceurs depuis Supabase ─────────
...
function priceHistoryBox(current, old, trend) {
...
${trendCtx}
Cherche le produit sur chaque boutique + codes promo sur dealabs.com.
Retourne UNIQUEMENT ce JSON :
{
  "summary": "conseil 1-2 phrases",
  "products": [{"name":"nom","price":"prix","store":${activeSlugs},"keywords":"mots clés","url":"url ou null"}],
  "promoCodes": [{"code":"CODE","store":"boutique","discount":"description","valid":true}]
}
Max 2 produits par boutique. Prix RÉELS. promoCodes:[] si rien.`,
        messages: [...(history||[]).slice(-4), {role:'user',content:`Recherche + codes promo : ${message}`}]
      })
    });
