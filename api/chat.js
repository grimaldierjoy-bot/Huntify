  ...
  try {
    ...
    const agentResp = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        system: `Agent shopping Huntify. Boutiques : ${activeNames}.
Fais exactement 2 recherches rapides :
1. Prix Amazon.fr pour le produit
2. Prix Rakuten pour le produit
Puis cherche un code promo si tu en vois un facilement.

Réponds UNIQUEMENT avec ce JSON (rien d'autre) :
{"summary":"phrase comparant les 2 prix","products":[{"name":"nom exact","price":"XX€","store":"amazon","keywords":"mots clés","url":"url directe ou null"},{"name":"nom exact","price":"Dès XX€","store":"rakuten","keywords":"mots clés","url":"url directe ou null"}],"promoCodes":[{"code":"CODE","store":"boutique","discount":"-XX%"}]}
promoCodes:[] si rien trouvé. Prix RÉELS uniquement.`,
        messages: [
          ...(history||[]).slice(-2),
